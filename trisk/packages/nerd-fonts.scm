...
(define FiraCode-hash
  "02b2p0gk0y998arisgknl7vmgyhxf2kfw19a3sxgfvqqbk67dmqs")
(define CommitMono-hash
  "0ci64628fpimb3sda2a9hi2g4ly15vkhgb9a897q8y560sv395ay")
(define iA-Writer-hash
  "1yd9n558fd63q8317s8my3nqn7q598zwv631k4p3g83mp9wash9r")
(define 3270-hash
  "196b92p74514pg6x8i09p1r841k82ci06yikvpn8ld7r6q4jx832")
(define IBMPlexMono-hash
  "1273jfwmyjq4l5nd9wddlmrqsjzzmab8mpa62l2aq3vnzb9gm654")
(define RobotoMono-hash
  "121rhk2nn24dwwmz9pqi77p6cx1gx0cz78x1fxn67f4ahfswyjp8")
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1s48knv0g7ksw4nmxb55f3w987f1qrjyd6l5rpy0rgsznjj515b4"))))
    (build-system font-build-system)
    (arguments
     `(#:phases (modify-phases %standard-phases
                  (add-before 'install 'make-files-writable
