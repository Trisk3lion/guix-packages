...
(define* (wrap-python3 python
                       #:optional (name (string-append (package-name python)
                                                       "-wrapper")))
    ...
    (arguments (list #:modules '((guix build utils))
                     #:builder #~(begin
                                   ...
                                   (let ((bin (string-append #$output "/bin"))
                                     ...
                                     (let ((bash (string-append (assoc-ref
                                                                 %build-inputs
                                                                 "bash")
                                                                "/bin/bash"))
                                           (old (string-append python
                                                 "python3-config"))
                                           (new (string-append bin
                                                 "/python-config")))
...
(define python-3.10-sqlite-ext
  (wrap-python3 (package/inherit python-3.10
  ...
  (package
    ...
    (source
     (origin
       (method url-fetch)
       (uri (string-append
             "https://github.com/podofo/podofo/archive/refs/tags/" version
             ".tar.gz"))
       (sha256
        (base32 "1v15903m3irc9ijpkcda4qlcmhwl0dd4v282pdzxvsgr8ck27qjb"))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "128w0bvasbyjbyazb390a7a7nxkh71nl45nmaj29ksfnfphfyp12"))
...
tags = [\"WS_X11\"]")
                   ...
                   (add-after 'install 'unbundle-font-liberation
                     (lambda _
                       (let ((font-dest (string-append #$output
                                         "/share/calibre/fonts/liberation"))
                             (font-src (string-append #$(this-package-input
                                                         "font-liberation")
    ...
    (description
     "Calibre is an e-book library manager.  It can view, convert
