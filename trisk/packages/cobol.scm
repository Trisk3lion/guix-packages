...
(define-public che-lsp-for-cobol
  (package
   ...
   (source (origin
            (method url-fetch)
            (uri (string-append "https://github.com/eclipse-che4z/che-che4z-lsp-for-cobol/releases/download/" version "/cobol-language-support-linux-x64-" version ".vsix"))
            (sha256
